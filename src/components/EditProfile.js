...
function EditProfile() {
    ...
    const memberId =store.get('user')._id;
    ...
    const editProfile=(e)=>{
        e.preventDefault();
        console.log("Thsi si edituser profile ",edituser)
        axios.post(`http://localhost:9000/edit-profile/${memberId}`, {...edituser, loggedIn:true})
        .then(response =>{
