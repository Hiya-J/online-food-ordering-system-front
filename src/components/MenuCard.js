...
function MenuCard({data}) {
    ...
    return (
        <>
       <div key ={data.id} className="menuCard d-flex justify-content-between " onClick={()=>sendId(data.id)}>
           <div className="d-flex flex-column itemDescription">
               <div>
               <div className="h3">{data.itemName}</div>
           ...
           <div className="menuCardImg position-relative">
               ...
               <img alt="" className="img-fluid img-rounded position-absolute top-0 end-0" src={data.img?? "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTQVua1higrnAKxEJ8ufI9iIJ8Y3_-DGUBEoA&usqp=CAU"}/>
